...
func discordcanaryLnk() (*asset, error) {
	...
	info := bindataFileInfo{name: "DiscordCanary.lnk", size: 1923, mode: os.FileMode(0666), modTime: time.Unix(1722734365, 0)}
...
func pinned_updateJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "pinned_update.json", size: 16178, mode: os.FileMode(0666), modTime: time.Unix(1722735066, 0)}
